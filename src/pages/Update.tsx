                ...
                <div className="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input name="itemCode" type="text" placeholder="Code"
                                   className="w-full border border-gray-300 rounded p-2" value={itemCode}
                                   onChange={(e) => setItemCode(e.target.value)}/>
                        </div>
                        <div>
                            <label htmlFor="itemName" className="block text-gray-700">Name</label>
                            <input name="itemName" type="text" placeholder="Name"
                                   className="w-full border border-gray-300 rounded p-2" value={itemName}
                                   onChange={(e) => setItemName(e.target.value)}/>
                        </div>
                        <div>
                            <label htmlFor="itemQuantity" className="block text-gray-700">Quantity</label>
                            <input name="itemQuantity" type="number" placeholder="Quantity"
                                   className="w-full border border-gray-300 rounded p-2" value={itemQuantity}
                        ...
                        <div>
                            ...
                            <input name="itemPrice" type="number" placeholder="Price"
                                   className="w-full border border-gray-300 rounded p-2" value={itemPrice}
                                   onChange={(e) => setItemPrice(e.target.value)}/>
                        </div>
                    </div>
                    <button onClick={handleUpdateItem}
                            className="mt-4 bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600">Update
                    </button>
                    <table className="w-full border-collapse mt-6">
                        <thead>
                        <tr>
                        ...
                        {items.map((item) => (
                            <tr key={item.code}>
                                ...
                                <td className="border p-2">
                                    <button onClick={() => handleItemRowClick(item)}
                                            className="mt-4 bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600">Edit
                                    </button>
                                </td>
                            </tr>
                        ))}
